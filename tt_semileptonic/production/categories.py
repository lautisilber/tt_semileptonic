...
"""
Categorizers for the categories that only become available after `production/ttbar_reco.py`
has run (chi2 pass/fail, |cos(theta*)| bins -- see config/categories_helper.py's
`add_categories_production`, id scheme docstring). Ported from mtt/production/categories.py.
"""
...
from tt_semileptonic.categorization.util import make_categorizer_not, make_categorizer_range
...
def sel_chi2pass(self: Categorizer, events: ak.Array, **kwargs) -> ak.Array:
