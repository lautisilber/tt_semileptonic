...
"""
Selector writing ak columns for cutflow features (per-step object kinematics/counts, for
``cf.PlotCutflowVariables``). Ported from mtt/selection/cutflow_features.py.
"""
...
def cutflow_features(self: Selector, events: ak.Array, results: SelectionResult, **kwargs) -> ak.Array:
    ...
    # count number of objects after applying selection
