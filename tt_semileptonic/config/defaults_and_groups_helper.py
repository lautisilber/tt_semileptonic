...
"""
Configuration of default values and groups for the tt_semileptonic analysis.
"""
...
def set_defaults(
    ...
    """
    Set default values for the tt_semileptonic analysis configuration.
    """
...
def set_process_groups(
    ...
    """
    Set groups for the tt_semileptonic analysis configuration.
    """
    run = config.campaign.x.run
    tag = config.x.cpn_tag
...
def set_dataset_groups(
    ...
    """
    Set groups for the datasets in the tt_semileptonic analysis configuration.
    """
    run = config.campaign.x.run
    tag = config.x.cpn_tag
...
def set_category_groups(
    ...
    """
    Set groups for the categories in the tt_semileptonic analysis configuration.
    """
    run = config.campaign.x.run
    tag = config.x.cpn_tag
...
def set_variables_groups(
    ...
    """
    Set groups for the variables in the tt_semileptonic analysis configuration.
    """
    run = config.campaign.x.run
    tag = config.x.cpn_tag
...
def set_shift_groups(
    ...
    """
    Set groups for the shifts in the tt_semileptonic analysis configuration.
    """
    run = config.campaign.x.run
    tag = config.x.cpn_tag
...
def set_selector_steps(
    ...
    """
    Set selector steps for the tt_semileptonic analysis configuration.
    """
    run = config.campaign.x.run
    tag = config.x.cpn_tag
